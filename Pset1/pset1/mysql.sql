/* Entrando no terminal para criar um usuario e logar com ele no mariadb.
...
ALTER TABLE cargos COMMENT 'Esta tabela  armazena os cargos existentes e a faixa salarial o minimo e o maximo de cada cargo';

ALTER TABLE cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Esta coluna possui a chave primária desta tabela.';

ALTER TABLE cargos MODIFY COLUMN cargo VARCHAR(35) COMMENT 'Esta tabela possui o nome de cada cargo';

ALTER TABLE cargos MODIFY COLUMN salario_minimo DECIMAL(8, 2) COMMENT 'Esta coluna diz o menor salário admitido para um cargo.';

ALTER TABLE cargos MODIFY COLUMN salario_maximo DECIMAL(8, 2) COMMENT 'Esta coluna diz o maior salário admitido para um cargo.';
...
ALTER TABLE regioes COMMENT 'Esta é a tabela que possui as informaçoes das regioes,numeros nomes e etc.';

ALTER TABLE regioes MODIFY COLUMN id_regiao INTEGER COMMENT 'Essa é a chave primaria desta tabela ';

ALTER TABLE regioes MODIFY COLUMN nome VARCHAR(25) COMMENT 'Coluna com os nomes das regioes.';
...
ALTER TABLE paises COMMENT 'Esta é a tabela que possui as informações dos países.';

ALTER TABLE paises MODIFY COLUMN id_pais CHAR COMMENT 'Esta é a chave primária desta tabela ';

ALTER TABLE paises MODIFY COLUMN nome VARCHAR(50) COMMENT 'Esta é a coluna com nomes da tabela paises.';

ALTER TABLE paises MODIFY COLUMN id_regiao INTEGER COMMENT 'Esta é a chave estrangeira para a tabela regioes.';
...
ALTER TABLE localizacoes COMMENT 'Esta é a tabela localizaçoes. Possui endreços de escritorios e facilidades da empresa.Não possui endereço de clientes.';

ALTER TABLE localizacoes MODIFY COLUMN id_localizacao INTEGER COMMENT 'Esta é a chave primaria desta tabela .';

ALTER TABLE localizacoes MODIFY COLUMN endereco VARCHAR(50) COMMENT 'e um escritório e ou facilidade da empresa.';

ALTER TABLE localizacoes MODIFY COLUMN cep VARCHAR(12) COMMENT ' ou escritorio';

ALTER TABLE localizacoes MODIFY COLUMN cidade VARCHAR(50) COMMENT 'facilidade da empresa ou escritorio.';

ALTER TABLE localizacoes MODIFY COLUMN uf VARCHAR(25) COMMENT 'so, com intuito de informar onde esta localizado o escritorio ou facilidade da empresa.';

ALTER TABLE localizacoes MODIFY COLUMN id_pais CHAR COMMENT 'es.';
...
ALTER TABLE departamento COMMENT 'Nesta tabela se encontram as informações sobre os departamentos da empresa.';

ALTER TABLE departamento MODIFY COLUMN id_departamento INTEGER COMMENT 'Essa é a chave primária desta tabela.';

ALTER TABLE departamento MODIFY COLUMN nome VARCHAR(50) COMMENT 'Nesta coluna se encontram nomes do departamento da tabela.';

ALTER TABLE departamento MODIFY COLUMN id_localizacao INTEGER COMMENT 'ao';

ALTER TABLE departamento MODIFY COLUMN id_gerente_ INTEGER COMMENT 'Esta coluna é a chave estrangeira para a tabela empregados';
...
CREATE TABLE empregados (
                ...
                id_supervisor INT,
                id_departamento INT,
                PRIMARY KEY (id_empregado_)
);

/* Apresentando comentarios referentes a tabela empregados com colunas pertecentes à mesma */

ALTER TABLE empregados COMMENT 'Esta tabela contém as informações de cada empregado.';

ALTER TABLE empregados MODIFY COLUMN id_empregado_ INTEGER COMMENT 'Esta coluna é a chave primária desta tabela.';

ALTER TABLE empregados MODIFY COLUMN nomr VARCHAR(750) COMMENT ' Esta coluna possui o nome completo do empregado.';

ALTER TABLE empregados MODIFY COLUMN email VARCHAR(35) COMMENT 'É o inicio do email do empregado porem antes do @.';

ALTER TABLE empregados MODIFY COLUMN telefone VARCHAR(20) COMMENT 'tado e codigo do pais.';

ALTER TABLE empregados MODIFY COLUMN data_contratacao DATE COMMENT 'Possui a data que o empregado iniciou no cargo em que atua .';

ALTER TABLE empregados MODIFY COLUMN salario DECIMAL(8, 2) COMMENT 'Possui o salário mensal atual de cada empregado.';

ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 'penas empregados no departamento
de vendas são elegíveis para comissoes.';

ALTER TABLE empregados MODIFY COLUMN id_supervisor INTEGER COMMENT ' empregados. Indica o supervisor direto do empregado correspondendo ou nao ao manager_id.
do departamento do empregado).';

ALTER TABLE empregados MODIFY COLUMN id_departamento INTEGER COMMENT 'ndica o departamento que o empregado esta atualmente';
...
CREATE TABLE historico_cargos (
                ...
                id_departamento INT,
                PRIMARY KEY (id_empregado_, data_inicial)
);

/* Apresentando comentarios referentes a tabela historico_cargos com colunas pertecentes à mesma */

ALTER TABLE historico_cargos COMMENT 'Esta Tabela armazena cargos de certo empregado. Caso houver a mudança de departamento dentro de um cargo ou mudar de cargo num departamento novas linhas devem ser inseridas nesta tabela com a informação
antiga do empregado.';

ALTER TABLE historico_cargos MODIFY COLUMN id_empregado_ INTEGER COMMENT 'Esta coluna é a chave primária desta tabela.';

ALTER TABLE historico_cargos MODIFY COLUMN data_inicial DATE COMMENT 'o_id e data_inicial).
Indica a data inicial do empregado em um novo cargo. Precisa ser menor do que a data_final.
data_final.';

ALTER TABLE historico_cargos MODIFY COLUMN data_final DATE COMMENT 'regado num determinado cargo. Sempre deve ser maior do que a data inicial';

ALTER TABLE historico_cargos MODIFY COLUMN id_cargo VARCHAR COMMENT 'os. Que corresponde ao cargo em que o
empregado estava trabalhando no passado.';

ALTER TABLE historico_cargos MODIFY COLUMN id_departamento INTEGER COMMENT 'rtamentos. A tal corresponde ao departamento
...
/* realizando alteraçao nas constraints da tabela departamento_historico */
...
/* realizando alteraçao nas constraints da tabela empregados_historico_cargos */
